...
urlpatterns = [
    ...
    path(
        "sources/",
        AppListView.as_view(model=models.Source, app_name="stemp"),
        name="sources",
    ),
    path("assumptions/", AssumptionsView.as_view(app_name="stemp"), name="assumptions"),
    path(
        "demand_selection/",
        views.DemandSelectionView.as_view(),
        name="demand_selection",
    ),
    path("demand/single/", views.DemandSingleView.as_view(), name="demand_single"),
    path(
    ...
    path(
        ...
        views.DemandSingleView.as_view(
            is_district_hh=True, only_house_type=constants.HouseType.MFH
        ),
    ...
    path(
        ...
        views.DemandSingleView.as_view(
            is_district_hh=True, only_house_type=constants.HouseType.EFH
        ),
    ...
    path("result/<list:results>", views.ResultView.as_view(), name="result_list"),
    path("addresses/", views.AdressesView.as_view(), name="addresses"),
    ...
    path("ajax/get_heat_demand/", views_dynamic.get_heat_demand,),
    path("ajax/get_square_meters/", views_dynamic.get_square_meters,),
    path("ajax/get_warm_water_energy/", views_dynamic.get_warm_water_energy,),
    path("ajax/get_roof_area/", views_dynamic.get_roof_area,),
    path("ajax/check_pending/", views_dynamic.check_pending,),
    path("ajax/get_household_summary/", views_dynamic.get_household_summary,),
]
